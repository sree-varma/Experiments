...
def load_test(test_path, image_size,num_channels,classes):
    X_test = []
    X_test_id = []
    labels = []
...
def read_train_sets(train_path, image_size, num_channels, classes, validation_size=0):
  class DataSets(object):
    pass
  data_sets = DataSets()

  images, labels, ids, cls = load_train(train_path, image_size,num_channels, classes)
...
def read_test_set(test_path, image_size,num_channels,classes):
  images, ids,labels  = load_test(test_path, image_size,num_channels, classes)
